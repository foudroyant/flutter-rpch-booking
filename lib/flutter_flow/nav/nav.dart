...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => DetailsHotelWidget(
        ...
        FFRoute(
          ...
          path: '/chambre',
          asyncParams: {
            'chambre': getDoc(['chambres'], ChambresRecord.fromSnapshot),
          },
          builder: (context, params) => ChambreWidget(
            chambre: params.getParam('chambre', ParamType.Document),
          ),
        ),
        FFRoute(
          name: 'Inscription',
        ...
        FFRoute(
          name: 'Biographie',
          path: '/biographie',
          builder: (context, params) => BiographieWidget(
        ...
        FFRoute(
          ...
          path: '/termsEtConditions',
          builder: (context, params) => const TermsEtConditionsWidget(),
        ),
        FFRoute(
          name: 'BooksHotels',
          path: '/booksHotels',
          builder: (context, params) => const BooksHotelsWidget(),
        ),
        FFRoute(
