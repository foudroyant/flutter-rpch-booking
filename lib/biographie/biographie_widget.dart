...
export 'biographie_model.dart';

class BiographieWidget extends StatefulWidget {
  const BiographieWidget({
    super.key,
    required this.email,
...
class _BiographieWidgetState extends State<BiographieWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BiographieModel());
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: 'Entrez une petite biographie',
                      hintStyle: FlutterFlowTheme.of(context).bodyLarge,
                      enabledBorder: OutlineInputBorder(
                        borderSide: BorderSide(
                          color: FlutterFlowTheme.of(context).primary,
