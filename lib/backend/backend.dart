...
import 'schema/chambres_record.dart';
...
export 'schema/chambres_record.dart';
...
/// Functions to query ChambresRecords (as a Stream and as a Future).
Future<int> queryChambresRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ChambresRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ChambresRecord>> queryChambresRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ChambresRecord.collection,
      ChambresRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ChambresRecord>> queryChambresRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
